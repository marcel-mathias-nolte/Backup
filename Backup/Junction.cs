...
namespace Backup
{
    public static class Junction
    {
        ...
        public static void Create(string junctionPoint, string targetDir, bool overwrite)
        {
            ...
            using (SafeFileHandle handle = OpenReparsePoint(junctionPoint, EFileAccess.GenericWrite))
            {
                ...
                try
                {
                    ...
                    int bytesReturned;
                    bool result = DeviceIoControl(handle.DangerousGetHandle(), FsctlSetReparsePoint, inBuffer, targetDirBytes.Length + 20, IntPtr.Zero, 0, out bytesReturned, IntPtr.Zero);
                    if (!result)
                    {
        ...
        private static extern bool DeviceIoControl(IntPtr device, uint iocontrolCode, IntPtr inbuffer, int inbufferSize, IntPtr outBuffer, int outBufferSize, out int bytesReturned, IntPtr overlapped);
        ...
        /// <summary>
        /// Get reparse point target from handle
        /// </summary>
        ...
        /// </summary>
        /// <param name="reparsePoint">the file to create an handle from</param>
        ...
        /// <summary>
        /// Throw the last Win32-Error as .NET-error
        /// </summary>
